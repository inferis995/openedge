    ...
    return (
        <div className="bg-white rounded-lg border border-gray-200 p-3 shadow-sm">
            ...
            <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-100">
                ...
                {isBool && (
                    <span className="text-[9px] font-bold uppercase tracking-wider text-blue-500 bg-blue-50 px-1.5 py-0.5 rounded">
                        BOOL
                    </span>
                )}
            </div>
            ...
            {!hasData ? (
                ...
                <>
                    ...
                    <div className="grid grid-cols-2 gap-2 mb-2">
                        {/* Min */}
                        <div className="flex items-center gap-2 bg-red-50 rounded px-2 py-1.5">
                            <TrendingDown className="w-3.5 h-3.5 text-red-500 flex-shrink-0" />
                            <div className="min-w-0">
                                <div className="text-[10px] text-red-600 font-medium uppercase tracking-wide">Min</div>
                                <div className={`text-sm font-bold ${isBool ? (stats.min_value && stats.min_value >= 0.5 ? 'text-green-600' : 'text-red-600') : 'text-gray-800'}`}>
                        ...
                        <div className="flex items-center gap-2 bg-green-50 rounded px-2 py-1.5">
                            ...
                            <div className="min-w-0">
                                <div className="text-[10px] text-green-600 font-medium uppercase tracking-wide">Max</div>
                                <div className={`text-sm font-bold ${isBool ? (stats.max_value && stats.max_value >= 0.5 ? 'text-green-600' : 'text-red-600') : 'text-gray-800'}`}>
                        ...
                        {/* Average */}
                        <div className="flex items-center gap-2 bg-blue-50 rounded px-2 py-1.5">
                            <Activity className="w-3.5 h-3.5 text-blue-500 flex-shrink-0" />
                            <div className="min-w-0">
                                <div className="text-[10px] text-blue-600 font-medium uppercase tracking-wide">Avg</div>
                        ...
                        {/* Std Dev */}
                        <div className="flex items-center gap-2 bg-purple-50 rounded px-2 py-1.5">
                            <Sigma className="w-3.5 h-3.5 text-purple-500 flex-shrink-0" />
                            <div className="min-w-0">
                                <div className="text-[10px] text-purple-600 font-medium uppercase tracking-wide">StDev</div>
                                <div className="text-sm font-bold text-gray-800">
                    ...
                    <div className="flex items-center justify-between text-[10px] text-gray-400 pt-2 border-t border-gray-100">
                        ...
                        <div className="bg-gray-100 px-1.5 py-0.5 rounded font-medium">
