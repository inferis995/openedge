...
const GatewaysPage = () => {
    ...
    const handleInputChange = (field: keyof CreateGatewayDto, value: any) => {
    ...
    const handleSelect = (id: number) => {
        // Usually navigate to Tags filtered by this Gateway, but store doesn't have selectedGatewayId
        // For now, simpler navigation just to Tags page, potentially adding filter query param later
            ...
            <div className="flex items-center justify-between">
                ...
                <Dialog open={isOpen} onOpenChange={setIsOpen}>
                    ...
                    <DialogContent className="max-w-xl">
                        ...
                        <DialogFooter>
                            <Button onClick={handleCreate}>Create Gateway</Button>
                        </DialogFooter>
                    </DialogContent>
                </Dialog>
            </div>
                                ...
                                >
                                    ...
                                    <TableCell className="font-medium">
                                        <div className="flex flex-col">
                                            <span>{gw.name}</span>
                                            <span className="text-xs text-muted-foreground">{gw.ip_address}</span>
                                        </div>
                                    </TableCell>
                                    <TableCell>
                                    ...
                                    <TableCell className="text-xs text-muted-foreground">
                                        {gw.driver_type === 'S7'
                                            ? `Rack: ${gw.rack}, Slot: ${gw.slot}`
                                            : `Port: ${gw.port}, ID: ${gw.slave_id}`
                                        }
                                        <br />
