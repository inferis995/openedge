...
const docTemplate = `{
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.CreateAreaRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.CreateGatewayRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/github_com_ralph_industrial-edge-middleware_internal_models.Gateway"
                        }
                    },
                    "400": {
                        "description": "Invalid request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.UpdateGatewayRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/history": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Aggregation function (mean, max, min, sum, first, last, count, median, stddev)",
                        "name": "agg",
                        "in": "query"
                    },
                    {
        ...
        "/api/sites": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Site creation request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.CreateSiteRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.UpdateTagRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.CurrentValueResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request",
    ...
    "definitions": {
        ...
        "github_com_ralph_industrial-edge-middleware_internal_models.Gateway": {
            "type": "object",
            "properties": {
                "area_id": {
                    "type": "integer"
        ...
        "internal_handlers.CreateGatewayRequest": {
            "type": "object",
            "required": [
                "area_id",
                "connection_config",
        ...
        "internal_handlers.CreateSiteRequest": {
            "type": "object",
            "required": [
                "name",
                "org_id"
        ...
        "internal_handlers.CurrentValueResponse": {
            "type": "object",
            "properties": {
                "q": {
                    "type": "integer"
        ...
        "internal_handlers.GatewayWithHealth": {
            "type": "object",
            "properties": {
                "area_id": {
                    "type": "integer"
        ...
        "internal_handlers.HistoryDataPoint": {
            "type": "object",
            "properties": {
                "quality": {
                    "type": "integer"
